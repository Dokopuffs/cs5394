...
/**
*   Thanks to David Kirchner dpk@dpk.net for his frame from the libgdx framework
*   Copyright 2013 Aaron Horn superboringturtle@hotmail.com
*
...
public class TiledMapHelper {
	 ...
	 */
	public void loadCollisions(String collisionsFile, GameWorld world,
	...
	/**
	 * Returns the water level on the tiled map.
	 * 
	 * @return water level 
	 */
	...
	/**
	 * Returns the x position of the slope on the tiled map.
	 * 
	 * @return slope's x location 
	 */
	...
	/**
	 * Returns the y position of the slope on the tiled map.
	 * 
	 * @return slope's y location 
	 */
